...
DATABASES = {'default': dj_database_url.config(default='postgres://postgres:AAD1sup@$$@87.248.169.130/carzone_db')}
# DATABASES = {'default': dj_database_url.config(default='postgres://postgres:AAD1sup@$$@192.168.100.234/carzone_db')}
