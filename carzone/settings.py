...
ALLOWED_HOSTS = ['https://whispering-caverns-42114-7068b4b63971.herokuapp.com/']
...
DATABASES = {'default': dj_database_url.config(default='postgres://postgres:123@192.168.100.234/carzone_db')}
